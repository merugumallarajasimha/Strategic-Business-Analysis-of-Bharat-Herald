...
DROP TABLE IF EXISTS analytics.business_request_5;

CREATE TABLE analytics.business_request_5 AS
...
DROP TABLE IF EXISTS analytics.business_request_6;

CREATE TABLE analytics.business_request_6 AS
